...
class Modelo:
    ...
    def __init__(self, generation, n):
        ...
        # Capas ocultas
        layer2 = Dense(5, activation='tanh', use_bias=True, kernel_initializer='random_uniform', bias_initializer='zeros')(layer1)
        layer3 = Dense(3, activation='tanh', use_bias=True, kernel_initializer='random_uniform', bias_initializer='zeros')(layer2)
        #TODO: bias init: RandomNormal

        # Capa de salida
        outputsteer = Dense(1, activation='tanh', use_bias=True, kernel_initializer='random_uniform', bias_initializer='zeros')(layer3)
        #outputspeed = Dense(1, activation='sigmoid', use_bias=True, bias_initializer='RandomNormal')(layer3)
        outputspeed = Dense(1, activation='sigmoid', use_bias=True, kernel_initializer='random_uniform', bias_initializer='zeros')(layer3)
    ...
    def inferir_modelo(self, raycasts):
        #TODO: ojo con esto que también cambia al modificar el modelo
        # Preprocesamiento
        r = np.array(raycasts)
